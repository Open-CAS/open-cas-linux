...
```
wget https://github.com/Open-CAS/open-cas-linux/releases/download/v20.3.3/open-cas-linux-v20.03.3.0307.tar.gz
tar -xf open-cas-linux-v20.03.3.0307.tar.gz
cd open-cas-linux-v20.03.3.0307/
```
