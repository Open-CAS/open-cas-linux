...
def test_standby_neg_cli_management():
    ...
    with TestRun.step("Prepare the standby instance"):
        ...
        blocked_mngt_commands = [
            ...
            cli.get_param_prefetch_cmd(str(cache_id)),
            cli.get_param_prefetch_readahead_cmd(str(cache_id)),
            ...
            cli.set_param_prefetch_cmd(str(cache_id), policy="readahead"),
            cli.set_param_prefetch_readahead_cmd(str(cache_id), threshold="128"),
