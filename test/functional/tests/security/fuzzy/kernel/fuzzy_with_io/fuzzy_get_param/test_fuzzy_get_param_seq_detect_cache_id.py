...
def test_fuzzy_get_param_seq_detect_cache_id(
    cache_mode, cache_line_size, unaligned_io, use_io_scheduler
):
    """
    title: Fuzzy test for casadm 'get parameter' command for sequence detector – cache id.
    description: |
        Using Peach Fuzzer check Open CAS ability of handling wrong cache id in 'get parameter'
        for sequence detector command.
    pass_criteria:
