...
def test_fuzzy_get_param_prefetch_readahead_cache_id(
    cache_mode, cache_line_size, unaligned_io, use_io_scheduler
):
    """
    title: Fuzzy test for casadm 'get parameter' command for prefetch readahead – cache id.
    description: |
    ...
    with TestRun.step("Using Peach Fuzzer create 'get parameter' command and run it."):
        ...
        base_cmd = get_param_prefetch_readahead_cmd(cache_id="{param}")
