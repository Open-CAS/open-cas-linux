...
def test_fuzzy_io_class_load_config_cache_id(cache_mode, cache_line_size, cleaning_policy,
                                             unaligned_io, use_io_scheduler):
    """
        title: Fuzzy test for casadm 'load IO class configuration' command – cache id.
    ...
    with TestRun.step("Prepare PeachFuzzer"):
        ...
        base_cmd = load_io_classes_cmd("{param}", "/etc/opencas/ioclass-config.csv").encode('ascii')
