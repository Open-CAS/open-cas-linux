...
def test_fuzzy_flush_cache(cache_mode, cache_line_size, cleaning_policy, unaligned_io,
                           use_io_scheduler):
    """
        title: Fuzzy test for casadm 'flush cache' command.
    ...
    with TestRun.step("Prepare PeachFuzzer"):
        ...
        base_cmd = flush_cache_cmd("{param}").encode('ascii')
