...
def test_fuzzy_reset_counters(cache_mode, cache_line_size, cleaning_policy, unaligned_io,
                              use_io_scheduler):
    """
        title: Fuzzy test for casadm 'reset counters' command.
        description: Using Peach Fuzzer check Open CAS ability of handling wrong 'reset counters'
            command.
        pass_criteria:
    ...
    with TestRun.step("Prepare PeachFuzzer"):
        ...
        base_cmd = reset_counters_cmd("{param}", str(core.core_id)).encode('ascii')
