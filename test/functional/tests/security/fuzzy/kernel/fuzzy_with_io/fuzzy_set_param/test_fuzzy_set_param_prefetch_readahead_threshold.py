...
threshold_min, threshold_max = PrefetchParametersReadahead.readahead_params_range().threshold
...
def test_fuzzy_set_param_prefetch_readahead_threshold(
    cache_mode, cache_line_size, unaligned_io, use_io_scheduler
):
    """
    title: Fuzzy test for casadm 'set parameter' command for prefetch readahead – threshold.
    description: |
        Using Peach Fuzzer check Open CAS ability of handling wrong threshold value in
        'set parameter' command for prefetch readahead parameters.
    pass_criteria:
