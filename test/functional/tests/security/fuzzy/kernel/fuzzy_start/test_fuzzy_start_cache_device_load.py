...
def test_fuzzy_start_cache_device_load(cache_mode, cache_line_size, unaligned_io, use_io_scheduler):
    """
        title: Fuzzy test for casadm 'start cache' command – load
    ...
    with TestRun.step("Prepare PeachFuzzer"):
        ...
        base_cmd = start_cmd("{param}", load=True).encode('ascii')
