...
def test_fuzzy_getparam_cleaning_acp_cache_id(cache_line_size, unaligned_io, use_io_scheduler):
    """
    title: test_fuzzy_getparam_cleaning_acp_cache_id
    ...
    with TestRun.step("Using Peach Fuzzer to create 'get parameter' command and run it."):
        ...
        base_cmd = get_param_cleaning_acp_cmd(cache_id="{param}").encode("ascii")
