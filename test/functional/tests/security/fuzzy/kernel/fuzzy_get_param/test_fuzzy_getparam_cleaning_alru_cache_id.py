...
def test_fuzzy_getparam_cleaning_alru_cache_id(cache_line_size, unaligned_io, use_io_scheduler):
    """
    title: test_fuzzy_getparam_cleaning_alru_cache_id
    description:  Fuzzy test for casadm 'get parameter' command – cache id in getting cleaning-acp parameters.
    ...
    with TestRun.step("Using Peach Fuzzer to create 'get parameter' command and run it."):
        ...
        base_cmd = get_param_cleaning_alru_cmd(cache_id="{param}").encode("ascii")
